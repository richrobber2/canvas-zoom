...
**T** - Open color panel right above the mouse ( Experimental)
...
3. This is not my bug, the problem is related to automatic1111. If you draw something in Sketch, Inpaint, Inpaint Sketch and then switch to another tab, then you go back, then undo will undo on previous 2 actions, last before switch and last after.
...
**T** - Открыть выбор цвета прямо над мышкой ( Работает немного коряво )
...
3. Это не мой баг, проблема связана с automatic1111. Если вы что-то нарисовали в Sketch, Inpaint, Inpaint Sketch, а потом переключили на другую вкладку, тогда вы вернетесь обратно, то отмена будет отменять по предыдущих 2 действия, последнее до переключения и последнее после.
