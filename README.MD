...
1. Если постоянно переключать Sketch, Inpaint, Inpaint Sketch в разных разрешениях через нижние кнопки, то картинка может обрезатся. Что бы решить эту проблему просто удалите картинку через крестик и снова перекиньте через кнопки или вручную.
