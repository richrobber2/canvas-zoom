...
You can turn on or off the white color of the brush outline in Inpaint. In the context menu.
...
Вы можете включить или отключить обводку кисти в Inpaint белым цветом. В контекстном меню.
