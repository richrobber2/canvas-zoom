...
**Found a bug, if you have the built-in extension and canvas-zoom enabled, then the zoom in controlNet does not work. So I strongly recommend to turn off the built-in extension, you won't lose anything.**
